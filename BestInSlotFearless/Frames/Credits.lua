...
function Credits:Draw(container)
  ...
  scroll:AddChild(header)
  -- urls
  scroll:AddChild(self:CreateUneditableTextbox("https://www.curseforge.com/wow/addons/BestInSlotFearless", "BestInSlotFearless on Curse.com"))
  scroll:AddChild(self:CreateUneditableTextbox("https://github.com/anhility/BestInSlotFearless", "BestInSlotFearless on Github.com"))
  ...
  -- Translation help
  scroll:AddChild(self:CreateUneditableTextbox("https://wow.curseforge.com/projects/BestInSlotFearless/localization", "Want to help translate BestInSlotFearless?"))
